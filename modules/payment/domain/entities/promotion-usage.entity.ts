...
export class PromotionUsageRecordedEvent extends DomainEvent {
  ...
  get eventType(): string { return 'promotion_usage.recorded'; }

  getPayload(): Record<string, unknown> {
    return { usageId: this.usageId, promoId: this.promoId, orderId: this.orderId };
  }
}
...
export class PromotionUsage extends AggregateRoot {
  ...
  static create(params: Omit<PromotionUsageProps, 'id'>): PromotionUsage {
    const entity = new PromotionUsage({
      ...params,
      id: PromotionUsageId.create(),
    });

    entity.addDomainEvent(new PromotionUsageRecordedEvent(
  ...
  get id(): PromotionUsageId { return this.props.id; }
  get promoId(): PromotionId { return this.props.promoId; }
