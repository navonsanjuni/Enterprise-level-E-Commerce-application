...
export interface ILoyaltyTransactionRepository {
  ...
  findExpiredByAccountId(accountId: LoyaltyAccountId): Promise<LoyaltyTransaction[]>;
  findWithFilters(filters: LoyaltyTransactionFilters, options?: LoyaltyTransactionQueryOptions): Promise<PaginatedResult<LoyaltyTransaction>>;
